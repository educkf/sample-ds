...
The `sample-button` component provides a flexible, themeable button for user interactions with comprehensive accessibility support.
...
{% playground %}
<sample-button>Default Button</sample-button>
<sample-button variant="secondary">Secondary</sample-button>
<sample-button variant="primary" size="small">Small</sample-button>
<sample-button variant="primary" size="large">Large</sample-button>
<sample-button disabled>Disabled</sample-button>

<script>
// Load the component for the playground
if (typeof window !== 'undefined' && !customElements.get('sample-button')) {
  import('../../dist/components/sample-button.js');
}
</script>
{% /playground %}
...
// Event typing
button.addEventListener('sample-click', (e: CustomEvent<{variant: string, size: string}>) => {
  console.log(e.detail.variant); // ✅ Typed
});
```
